...
export function ResultsReportViewer() {
  ...
  const [astRawText, setAstRawText] = useState('');
  const [fullRawText, setFullRawText] = useState('');
  const [astFileName, setAstFileName] = useState('');
  const [fullFileName, setFullFileName] = useState('');
  const [compareError, setCompareError] = useState('');
  const [compareWarnings, setCompareWarnings] = useState<string[]>([]);
  const [astReport, setAstReport] = useState<ParsedReportData | null>(null);
  const [fullReport, setFullReport] = useState<ParsedReportData | null>(null);
